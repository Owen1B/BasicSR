...
./scripts/run_experiments.sh tier1 all

# Run specific method
./scripts/run_experiments.sh tier1 n2n
./scripts/run_experiments.sh tier1 n2b
./scripts/run_experiments.sh tier1 n2v
./scripts/run_experiments.sh tier1 s2s

# Specify GPU
CUDA_VISIBLE_DEVICES=1 ./scripts/run_experiments.sh tier1 all
```
...
```bash
./scripts/run_experiments.sh tier2 norm
