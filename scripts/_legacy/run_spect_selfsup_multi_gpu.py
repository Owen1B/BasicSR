...
用法:
    python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1
    python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1 --group tier1
    python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1,2,3 --dry-run
    python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1 --skip-existing
    python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1 --debug  # 200步快速测试
...
class ExperimentScheduler:
    ...
    def _run_experiment(self, exp: Experiment, gpu_id: int):
        ...
        cmd = [sys.executable, "-m", "prime.train", "-opt", str(config_path)]
...
示例:
  # 正式运行
  python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1 --group all
  python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1,2,3 --group tier2
  python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1 --skip-existing

  # Debug 模式 (快速测试配置和显存)
  python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1 --debug
  python scripts/run_spect_selfsup_multi_gpu.py --gpus 0,1 --debug --debug-iters 100

  # 查看实验组
  python scripts/run_spect_selfsup_multi_gpu.py --list
        """
    )
