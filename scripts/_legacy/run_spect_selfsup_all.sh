...
# ============================================================
# 用法:
#   ./scripts/run_spect_selfsup_all.sh                  # 运行所有实验
#   ./scripts/run_spect_selfsup_all.sh baseline         # 只运行 baseline
#   ./scripts/run_spect_selfsup_all.sh tier1            # 只运行 tier1
#   ./scripts/run_spect_selfsup_all.sh tier2            # 只运行 tier2 全部
#   ./scripts/run_spect_selfsup_all.sh tier2_norm       # 只运行 tier2 norm 消融
#   ./scripts/run_spect_selfsup_all.sh tier3            # 只运行 tier3
#   ./scripts/run_spect_selfsup_all.sh list             # 列出所有实验
#
# 环境变量:
...
run_experiment() {
    ...
    python -m prime.train -opt "$full_config" --auto_resume
...
case "${1:-all}" in
    ...
    *)
        ...
        echo ""
        echo "示例:"
        echo "  ./scripts/run_spect_selfsup_all.sh list"
        echo "  ./scripts/run_spect_selfsup_all.sh tier2_norm"
        echo "  CUDA_VISIBLE_DEVICES=1 ./scripts/run_spect_selfsup_all.sh all"
        echo "  DRY_RUN=1 ./scripts/run_spect_selfsup_all.sh all"
        exit 1
        ;;
esac
