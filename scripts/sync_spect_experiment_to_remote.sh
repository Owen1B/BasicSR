...
#     EXPERIMENT_NAME=converged_tomo_3d_nview \
#     bash scripts/sync_spect_experiment_to_remote.sh
...
if [[ -z "${EXPERIMENT_NAME}" ]]; then
  echo "ERROR: EXPERIMENT_NAME is required (e.g. converged_tomo_3d_nview)" >&2
  exit 2
fi
