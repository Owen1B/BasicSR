...
# 用法: ./scripts/run_baseline_debug.sh [n2n|n2v|n2b|fpn|all]
...
case "${1:-all}" in
    ...
    *)
        ...
        echo ""
        echo "Example:"
        echo "  ./scripts/run_baseline_debug.sh n2n                    # 200 iters"
        echo "  TOTAL_ITER=500 ./scripts/run_baseline_debug.sh all     # 500 iters"
        exit 1
        ;;
esac
